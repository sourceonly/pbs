...
os.environ['ALTAIR_LM_LICENSE_FILE']= '6200@192.168.40.66'
...
#  os.environ['PBS_RSHCOMMAND']="/usr/bin/rsh"
  ...
  os.environ['LD_LIBRARY_PATH']="/data/apps/hyperworks/altair/hwsolvers/bin/linux64"
...
#                          engine_cmd = engine_cmd + " -cpu_bind=v,ll -stdio=i0 -e MPI_FLAGS=y,E"
	#                  engine_cmd = engine_cmd + " -e ALTAIR_LICENSE_PATH=" + os.environ['ALTAIR_LICENSE_PATH']
			  engine_cmd = engine_cmd + " -e ALTAIR_LICENSE_PATH=" + "6200@192.168.40.66"
